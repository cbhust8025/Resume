...
\par{介绍：就职于CSIG安全产品部门，历经腾讯电脑管家IOA云盾、小团队版、15版本、16版本以及远程管家等C/B端产品的开发。具备丰富的Windows平台C++开发经验，不仅擅长常规需求功能开发，还担任过安装包优化、PC远程等多个项目的负责人。凭借出色的技术实力和独立推动项目的能力，成功申请并发表了多篇腾讯远程专利。}
\vspace{1.0ex}
